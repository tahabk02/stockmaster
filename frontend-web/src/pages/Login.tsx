      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-12 z-10">
        ...
        >
          ...
          <div className={cn("mb-10", isRtl ? "text-right" : "text-left")}>
            <div
              className={cn(
                "bg-indigo-600 w-14 h-14 rounded-2xl flex items-center justify-center mb-6 shadow-xl",
                isRtl && "ml-auto mr-0",
              )}
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <p
              className={cn(
                "text-center text-[10px] font-bold text-slate-400 uppercase tracking-widest pt-4",
                isRtl && "text-right",
              )}
            >
              New to the cluster?{" "}
      ...
      <div className="hidden lg:flex flex-1 relative overflow-hidden bg-indigo-900">
        ...
        <div className="relative mt-auto p-16 w-full">
          <motion.div
            ...
            className="bg-white/10 backdrop-blur-xl border border-white/10 p-10 rounded-[3rem] shadow-2xl"
          >
            <div
              className={cn(
