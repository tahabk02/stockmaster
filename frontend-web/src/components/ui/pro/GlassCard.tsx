...
export const GlassCard = ({ 
  ...
  const variants = {
    default: "bg-white/80 dark:bg-slate-900/60 border-slate-200/50 dark:border-white/5",
    dark: "bg-slate-950/90 border-white/10 text-white",
    gradient: "bg-gradient-to-br from-indigo-600/90 to-violet-700/90 border-white/10 text-white shadow-3xl shadow-indigo-500/20"
  };
  ...
  return (
    ...
    <Wrapper
      ...
      {...animationProps}
      className={cn(
        "backdrop-blur-2xl rounded-[2rem] border p-6 relative overflow-hidden shadow-2xl transition-all",
        variants[variant],
