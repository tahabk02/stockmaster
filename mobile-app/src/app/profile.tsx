...
export default function ProfilePage() {
  ...
  const handleLogout = async () => {
    ...
    Alert.alert(
      t("PROFILE.TERMINATE_SESSION"),
      t("PROFILE.ENCRYPTED_LOGOUT_PROTOCOL_INITIATED"),
      [
  ...
  const changeLanguage = async (lng: string) => {
    ...
    try {
      await api.patch("users/preferences", { language: lng });
    } catch (e) {}
  };
  ...
  const handleToggleTheme = async () => {
    ...
    await toggleTheme();
    try {
      await api.patch("users/preferences", { darkMode: !isDarkMode });
    } catch (e) {}
  };
    ...
    >
      ...
      <View style={styles.fixedHeader}>
        ...
        >
          <TouchableOpacity
            ...
            style={[
              styles.tabBtn,
              activeTab === "PORTAL" && { backgroundColor: colors.primary },
            ]}
          >
            <Text
              style={[
                styles.tabText,
                {
                  color: activeTab === "PORTAL" ? "#fff" : colors.textLight,
                  ...typography.pro,
                  fontSize: 8,
                },
              ]}
            >
              {t("PROFILE.CLIENT_PORTAL")}
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => {
          ...
          >
            <Text
              style={[
                styles.tabText,
                {
                  color: activeTab === "SETTINGS" ? "#fff" : colors.textLight,
                  ...typography.pro,
                  fontSize: 8,
                },
              ]}
            >
              {t("PROFILE.NODE_SETTINGS")}
            </Text>
          </TouchableOpacity>
        </View>
        <TouchableOpacity
      ...
      >
        {activeTab === "PORTAL" ? (
          ...
          <Animated.View entering={FadeInDown}>
            ...
            <View style={styles.identityMatrix}>
              ...
              >
                {user?.name || t("PROFILE.OPERATOR_01")}
              </Text>
              <Text
                style={[
                  styles.userRole,
            ...
            <GlassCard style={styles.forensicCard}>
              ...
              >
                <ForensicItem
                  icon={<Database size={12} color={colors.primary} />}
                  label={t("PROFILE.NODE_ID")}
                  value={user?._id?.substring(0, 8).toUpperCase() || "UNK_NODE"}
                  theme={theme}
                />
                <View
                ...
                />
                <ForensicItem
                  icon={<Activity size={12} color={colors.accent} />}
                  label={t("PROFILE.UPTIME")}
                  value={uptime}
                  theme={theme}
                  color={colors.accent}
                />
            ...
            >
              {t("PROFILE.CONTROL_MATRIX")}
            </Text>
            <GlassCard style={styles.controlMatrix}>
              <ControlItem
                icon={<Bell size={18} color={colors.primary} />}
                label={t("PROFILE.NOTIFICATIONS")}
                desc={t("PROFILE.SIGNAL_INTERCEPT")}
              ...
              <ControlItem
                ...
                desc={
                  isDarkMode
                    ? t("PROFILE.OLED_BLACK_ACTIVE")
                    : t("PROFILE.SOLAR_LIGHT_ACTIVE")
                }
                value={isDarkMode}
                    ...
                    >
                      <Text
                        style={[
                          ...
                          {
                            color:
                              i18n.language === l ? "#fff" : colors.textLight,
                            fontWeight: "900",
                          },
                        ]}
                      >
            ...
            >
              ...
              >
                {t("PROFILE.TERMINATE_SECURE_SESSION")}
              </Text>
            </TouchableOpacity>
          </Animated.View>
        )}
        ...
        <View style={styles.footer}>
          ...
          >
            {t("PROFILE.NODE_STATUS")} {Platform.OS.toUpperCase()}_LIVE
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
