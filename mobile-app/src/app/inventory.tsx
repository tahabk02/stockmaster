        ...
        >
          ...
          >
            <View style={styles.cardHeader}>
              ...
              >
                <PulseIndicator
                  color={isCritical ? colors.danger : colors.accent}
                  size={4}
                />
                <Text
                  style={[
            ...
            <View style={styles.metricsGrid}>
              <View style={styles.metricItem}>
                ...
                <View style={styles.valueRow}>
                  ...
                  <Text style={[styles.unitLabel, { color: colors.textLight }]}>
                    UNITS
                  </Text>
                </View>
              </View>
              ...
              {isOffline && (
                <View style={styles.offlineBadge}>
                  ...
                  <Text
                    style={[
                      styles.offlineText,
                      { color: colors.warning, ...typography.pro },
                    ]}
                  >
                    LOCAL_CACHE_MODE
                  </Text>
